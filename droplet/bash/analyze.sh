...
#Ex:
# ./exec/analyze.sh /home/oge1/lammps/sapphire/analysis/results/50A/atom1/calculated.txt 50A/atom7 polarScatter
...
#Run root analysis
echo "Running $3"
echo /home/oge1/lammps/sapphire/analysis/root/$3.out $1 $out_folder $4
/home/oge1/lammps/sapphire/analysis/root/$3.out $1 $out_folder $4

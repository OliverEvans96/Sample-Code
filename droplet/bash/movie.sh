...
#Create movie
echo "Creating movie"
/home/oge1/.local/bin/ffmpeg -r 4 -i ${folder}/%*.$ext -c:v mpeg4 -qscale:v 3 -pix_fmt yuv420p -y movies/${name}.mp4
...
moviename=/home/oge1/lammps/sapphire/analysis/results/movies/${name}_${sim}
mkdir -p ${moviename%/*}
